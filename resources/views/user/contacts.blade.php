...
<section id="section3">
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="contactus">
                    <h4>{{ __('contact.label_our_contacts') }}</h4>
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="emailicon">
                        ...
                        <div class="col-sm-9">
                            <div class="emailtext">
                                <h5 id="email"><a href="">email.e@gmail.com</a></h5>
                                <label for="email" class="small">{{ __('contact.label_call_me_today') }}</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-9">
                            <div class="phonenumbertext">
                                <h5 id="phonenumber"><a href="">8 700 100 20 40</a></h5>
                                <label for="phonenumber" class="small">{{ __('contact.label_call_me_today') }}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="worktime mt-5">
                    <h4>{{ __('contact.label_work_time') }}</h4>
                    <ul>
                        <li>{{ __('contact.label_monday_friday') }} 8:00 - 18:00</li>
                        <li>{{ __('contact.label_saturday') }} 9:00 - 17:00</li>
                        <li>{{ __('contact.label_sunday') }} {{ __('contact.label_weekend') }}</li>
                    </ul>
                </div>
            </div>
        </div>
